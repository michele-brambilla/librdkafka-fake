...
void setMetadataPointerInvalid() { utils::Storage::MetadataPointerValid = false; }
bool metadataPointerValid() { return utils::Storage::MetadataPointerValid; }

void setMetadataReturnValueOk() { utils::Storage::MetadataErrorCode = RdKafka::ERR_NO_ERROR; }
void setMetadataReturnValueError() { utils::Storage::MetadataErrorCode = RdKafka::ERR_UNKNOWN; };
